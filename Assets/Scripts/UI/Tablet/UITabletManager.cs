...
namespace UI.Tablet
{
    public class UITabletManager : BaseUI
    {
        ...
        protected override void OnEnable()
        {
            ...
            // Catalogs
            buttonCatalogLicense.onClick.AddListener(OnButtonClickedLicense);
            buttonCatalogProduct.onClick.AddListener(OnButtonClickedProduct);
            buttonCatalogFurniture.onClick.AddListener(OnButtonClickedFurniture);
            buttonCatalogDecoration.onClick.AddListener(OnButtonClickedDecoration);
            buttonCatalogWorkers.onClick.AddListener(OnButtonClickedWorkers);
            buttonCatalogExpand.onClick.AddListener(OnButtonClickedExpand);
            buttonCatalogFight.onClick.AddListener(OnButtonClickedFight);
        ...
        protected override void OnDisable()
        {
            ...
            // Catalogs
            buttonCatalogLicense.onClick.RemoveListener(OnButtonClickedLicense);
            buttonCatalogProduct.onClick.RemoveListener(OnButtonClickedProduct);
            buttonCatalogFurniture.onClick.RemoveListener(OnButtonClickedFurniture);
            buttonCatalogDecoration.onClick.RemoveListener(OnButtonClickedDecoration);
            buttonCatalogWorkers.onClick.RemoveListener(OnButtonClickedWorkers);
            buttonCatalogExpand.onClick.RemoveListener(OnButtonClickedExpand);
            buttonCatalogFight.onClick.RemoveListener(OnButtonClickedFight);

...
public class UIFloatingIconCollect : BaseUI
{
    [Header("Settings")]
    ...
    /// </summary>
    /// <param name="spriteIcon">Icon to display</param>
    ...
    public void Initialize(Sprite spriteIcon, Vector2 startScreenPos, Vector2 targetScreenPos)
    {
